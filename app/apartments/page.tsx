...
export default function ApartmentsPage() {
  ...
  const apartments = homeProperties.filter(
    (property) => property.title.toLowerCase().includes('apartment') || property.title.toLowerCase().includes('flat')
  )

  const filteredProperties = apartments.filter(
    (property) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover premium apartments and serviced flats in prime locations. Perfect for modern living and investment.
            </p>
          </div>
