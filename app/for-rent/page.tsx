...
export default function ForRentPage() {
  ...
  const forRentProperties = homeProperties.filter(
    (property) => property.type === 'For Rent'
  )

  const filteredProperties = forRentProperties.filter(
    (property) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Browse our collection of rental properties. Find the perfect place to rent with flexible terms and great amenities.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {filteredProperties.length === 0 ? (
          <div className="text-center py-20 text-muted-foreground text-lg">
            {searchQuery ? 'No properties found matching your search.' : 'No properties for rent at the moment.'}
          </div>
        ) : (
