...
export default function CommercialPage() {
  ...
  const commercialProperties = homeProperties.filter(
    (property) => property.type === 'Commercial'
  )

  const filteredProperties = commercialProperties.filter(
    (property) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore premium commercial spaces for your business. From offices to retail, find the right location for growth.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {filteredProperties.length === 0 ? (
          <div className="text-center py-20 text-muted-foreground text-lg">
            {searchQuery ? 'No properties found matching your search.' : 'No commercial properties at the moment.'}
          </div>
        ) : (
