...
export default function LandPage() {
  ...
  const landProperties = homeProperties.filter(
    (property) => property.type === 'Land'
  )

  const filteredProperties = landProperties.filter(
    (property) =>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover prime land opportunities. Whether for development or investment, find the perfect plot in your desired location.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {filteredProperties.length === 0 ? (
          <div className="text-center py-20 text-muted-foreground text-lg">
            {searchQuery ? 'No properties found matching your search.' : 'No land properties at the moment.'}
          </div>
        ) : (
