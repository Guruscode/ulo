...
import { Search, MapPin, Star, Wifi, Waves, Utensils, Car, Dumbbell } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover premium hotels across Nigeria. From luxury suites to comfortable rooms, find your perfect stay.
            </p>
          </div>
            ...
            {filteredHotels.map((hotel) => (
              <Link key={hotel.id} href={`/hotels/${hotel.id}`}>
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer group h-full">
                  ...
                  {/* Hotel Info */}
                  <div className="p-5">
                    <h3 className="text-lg font-bold text-secondary mb-1 group-hover:text-secondary/80 transition-colors">
                      {hotel.name}
                    </h3>
                    ...
                    <div className="flex items-baseline justify-between pt-3 border-t">
                      <div>
                        <span className="text-2xl font-bold text-secondary">₦{hotel.price.replace('₦', '')}</span>
